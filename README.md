...
- [Hints and Considerations](#hints-and-considerations)
- [Requirements](#requirements)
  - [The requirements for "Part 1: WeatherPy" are the following](#the-requirements-for-part-1-weatherpy-are-the-following)
    - [Create Plots to Showcase the Relationship Between Weather Variables and Latitude (30 points)](#create-plots-to-showcase-the-relationship-between-weather-variables-and-latitude-30-points)
    - [Compute Linear Regression for Each Relationship (40 points)](#compute-linear-regression-for-each-relationship-40-points)
  - [The requirements for "Part 2: VacationPy" are the following (30 points)](#the-requirements-for-part-2-vacationpy-are-the-following-30-points)
...
![instruction_imgs/linear-regression-plot.png](instruction_imgs/linear-regression-plot.png)
...
![instruction_imgs/humidity_map.png](instruction_imgs/humidity_map.png)
...
![instruction_imgs/hotel_map.png](instruction_imgs/hotel_map.png)
